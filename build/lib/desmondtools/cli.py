...
def maeinfo() -> None:
    ...
    subprocess.run([schrodinger_run, script_path.joinpath('batch-maeinfo.py')])

def cmsinfo() -> None:
    # requires Schrodinger Python API
    subprocess.run([schrodinger_run, script_path.joinpath('batch-cmsinfo.py')])

def convert_to_dcd() -> None:
